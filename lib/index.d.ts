...
export { getDeviceCount, getDeviceName, getDeviceUSBStrings, getIndexBySerial, open, close, ghz, mhz, khz, rtlsdr_tunerEnum, RTLSDRDevice, DeviceUSBStrings, XtalFreq, baremetal };
