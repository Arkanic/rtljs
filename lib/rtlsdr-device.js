...
var RTLSDRDevice = /** @class */ (function () {
    ...
    RTLSDRDevice.prototype.readAsync = function (callback, buf_num, buf_len) {
        var rtlsdrCallback = ffi_napi_1.default.Callback("void", ["char*", "uint32", "void"], callback);
        // @ts-ignore
        baremetal_1.librtlsdr.rtlsdr_read_async.async(this.device, rtlsdrCallback, ref_napi_1.default.NULL, buf_num, buf_len, function (err, value) {
            if (err)
                throw err;
        });
    };
